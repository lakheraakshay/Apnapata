        ...
        <div className={classes.card}>
          <div className={classes.left}>
            <div className={classes.image}>
              ...
              <div className="description">{data.photos.length} Photos</div>
            </div>
          ...
          <div className={classes.right}>
            <div className="title">
              <Typography variant="h5">
                3 BHK Apartment <span>2500 sqft</span>
              </Typography>
            </div>
            <div className={classes.properties}>
              ...
              <div className="prop-grp">
                <p className="prop-title">ELEVATION</p>
                <p className="prop-val">3D - 2D</p>
              </div>
